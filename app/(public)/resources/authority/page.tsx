    ...
    <article className="resource-article public-light">
      <header className="resource-article__header">
        <div className="resource-article__header-shell">
          ...
          <h1>The critical question is not only who the actor is.</h1>

          <p>
            Governance must also understand what the actor can access, change, execute or influence, under which conditions, and where that authority ends.
          </p>
        </div>
      </header>
