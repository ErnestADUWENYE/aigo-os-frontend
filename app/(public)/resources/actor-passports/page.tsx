    ...
    <article className="resource-article public-light">
      <header className="resource-article__header">
        <div className="resource-article__header-shell">
          ...
          <h1>Every AI actor needs a governance identity.</h1>

          <p>
            An Actor Passport connects fragmented technical observations with ownership, provenance, relationships, lifecycle and governance context.
          </p>
        </div>
      </header>
