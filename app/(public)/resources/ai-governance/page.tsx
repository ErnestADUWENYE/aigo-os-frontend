    ...
    <article className="resource-article public-light">
      <header className="resource-article__header">
        <div className="resource-article__header-shell">
          ...
          <h1>AI governance is becoming an operating discipline.</h1>

          <p>
            As AI moves from models into agents, applications and autonomous workflows, governance must move closer to the systems and decisions it is intended to govern.
          </p>
        </div>
      </header>
